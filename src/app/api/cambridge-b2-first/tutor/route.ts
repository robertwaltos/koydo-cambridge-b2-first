...
const EXAM_ID = "cambridge-b2-first";
const EXAM_DISPLAY_NAME = "Cambridge B2 First (FCE)";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. Respond in English.

Cover Reading & Use of English, Writing, Listening, and Speaking components. Align to Cambridge Assessment English B2 First specifications.
