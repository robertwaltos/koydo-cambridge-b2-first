...
export const metadata: Metadata = {
  title: "Learn — Cambridge B2 First Practice",
  description: "Study and practice for Cambridge B2 First. Choose your subject and start preparing.",
};
