// Auto-generated shim — re-exports from @/lib/cambridge-b2-first/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as _cambridge_b2_first_Config } from "@/lib/cambridge-b2-first/config";
import { EXAM_CONFIG as _raw } from "@/lib/cambridge-b2-first/config";
