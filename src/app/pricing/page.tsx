...
export const metadata: Metadata = {
  title: "Pricing — Cambridge B2 First Premium",
  description: "Unlock unlimited Cambridge B2 First practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=cambridge-b2-first&cadence=annual`;
